...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		myTriangle(g2, Color.GREEN, 0.5, 1.25, 2, 0.5);
	...
	private void myRotatingPolygon(Graphics2D g2, double sx, double sy, double pointX, double pointY) {
		AffineTransform old = g2.getTransform();

		g2.translate(pointX, pointY);
		g2.setColor(Color.BLACK);
		g2.rotate((frameNumber * 0.75) * 0.75);
		g2.scale(sx, sy);
		myFilledPolygon(g2);
		g2.setTransform(old);
	}

	private void myFilledPolygon(Graphics2D g2) {
	...
	private void myRectangle(Graphics2D g2, double sx, double sy, double pointX, double pointY) {
		AffineTransform old = g2.getTransform();
		g2.translate(pointX, pointY);
		g2.rotate(-22.38);
	...
	private void myTriangle(Graphics2D g2, Color color, double sx, double sy, double pointX, double pointY) {
		AffineTransform old = g2.getTransform();
		g2.translate(pointX, pointY);
		g2.setColor(color);
		g2.scale(sx, sy);
